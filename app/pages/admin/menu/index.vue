...
const { menuItems, loading, fetchMenu, deleteItem } = useMenu()
...
const columns = [
  ...
  { key: 'to', label: 'Destino', type: 'text' },
...
<template>
  <div>
    ...
    <div v-if="loading && menuItems.length === 0" class="flex justify-center py-12">
    ...
    >
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-6 w-full max-w-md shadow-2xl">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 class="text-lg font-bold text-white">¿Eliminar elemento del menú?</h3>
